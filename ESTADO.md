...
- [ ] **Subir los videos del curso a Bunny.** Hoy hay **1 video de prueba** (`f8e8fda0-f7ac-40fb-8c29-b36f6bfe1b78`) conectado a las TRES lecciones de cortesía (`s2-l01/02/03`) — es el mismo en las tres, puesto por Cristian el 2026-09-15 para poder probar el embudo. No hacen falta los 58 para lanzar, pero **antes de enseñárselo a nadie hay que poner el video real de cada una**.
  ⚠️ **Esto NO está en ninguna migración, a propósito.** Es contenido de prueba: si viajara en un archivo de migración acabaría en producción, con las tres lecciones enseñando el mismo video de prueba. El contenido se carga contra cada base, no se versiona con el esquema.
  ✅ **Verificado el 2026-09-15**: el reproductor lo carga con el enlace firmado y Bunny responde 200 en todo (playlist, 720p, miniatura) — ni un 403. Y **se ve sin franjas blancas**: el video es horizontal y llena el marco 16:9, lo que confirma la decisión de dejar el contenedor como está.
